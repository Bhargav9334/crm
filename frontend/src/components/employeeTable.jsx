              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                  ...
                  {emp.profilePicture ? (
                    ...
                    <div className="w-14 h-14 rounded-full bg-gradient-to-r from-blue-500 to-indigo-600 flex items-center justify-center text-white font-bold text-lg">
                  ...
                  <div>
                    ...
                    <span className="mt-1 inline-block text-xs px-3 py-1 rounded-full bg-blue-100 text-blue-700 font-medium">
                      {emp.role || "—"}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() => onEdit?.(emp)}
                    className="p-2 border rounded-lg hover:bg-blue-50 transition text-blue-600"
                  >
                    <Pencil size={15} />
                  </button>
